return {
    ...
    -- dotdotdot tuek's sietch option
    ...
    -- dotdotdot leader abilities in chat log
    harkonnenAdvisorTooltip = "Harkonnen Advisor",
    reverseEngineeringTooltip = "Reverse Engineering - 1 spice",
    tueksSietchPayment = "↯ Thanks for visiting Esmar Tuek's Sietch",
    ...
    -- dotdotdot bloodlines imperium cards
    bl_Bombast = "Bombast",
   ...
   -- dotdotdot piter twisted intrigues
   ...
   -- dotdotdot conflicts
    ...
    -- dotdotdot added (solaris) for distinction
    ...
    -- dotdotdot bloodlines contracts
