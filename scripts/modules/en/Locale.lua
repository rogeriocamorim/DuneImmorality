return {
    ...
    -- Fanmade leaders
    rt_helenaRichese = "Helena Richese",
    rt_farok = "Farok",
    rt_ilbanRichese = "Ilban Richese",
    rt_jopatiKolona = "Jopati Kolona",
    rt_letoAtreidesII = "Leto Atreides II",
    rt_xavierHarkonnen = "Xavier Harkonnen",
    rt_countFenring = "Count Fenring",
    rt_drisq = "Drisq",
    rt_executrix = "Executrix",
    rt_mirlat = "Mirlat",
    rt_dukeMutelli = "Duke Mutelli",
    rt_isyanderTheTraitorShaiad = "Isyander the Traitor Shaiad",
    rt_swormasterDinari = "Swormaster Dinari",
    rt_koalTraytron = "Koal Traytron",
    rt_aliaAtreides = "Alia Atreides",
    rt_princessYunaMoritani = "Princess Yuna Moritani",
    rt_masterBijaz = "Master Bijaz",
    rt_tessiaVernius = "Tessia Vernius",
    rt_shaddamIV = "Shaddam IV",
    rt_captainOtto = "Captain Otto",
    rt_princessWensicia = "Princess Wensicia",
    rt_generalKlevLagarin = "General Klev Lagarin",
    rt_masterWaff = "Master Waff",
    rt_scytale = "Scytale",
    rt_drLietKynes = "Dr Liet Kynes",
    rt_princessIrulan = "Princess Irulan",
    rt_bannerjee = "Bannerjee",
    rt_serenaButler = "Serena Butler",
    rt_shaddamV = "Shaddam V",
    rt_edric = "Edric",
    rt_shimoon = "Shimoon",
    rt_anirulCorrino = "Anirul Corrino",
    rt_omniusPrime = "Omnius Prime",
    rt_uliet = "Uliet",
    rt_pretresseIsyaraStShaiad = "Pretresse Isyara St'Shaiad",
    rt_princeRhomburVernius = "Prince Rhombur Vernius",
    rt_memnonThorvald = "Memnon Thorvald",
    rt_senatorOthn = "Senator Othn",
    rt_viscountHundroMoritani = "Viscount Hundro Moritani",
    rt_vorianAtreides = "Vorian Atreides",
    rt_whitmoreBludd = "Whitmore Bludd",
    rt_torgTheYoung = "Torg the Young",
    rt_normaCenva = "Norma Cenva",
    rt_senateurMaximilienZelevas = "Senateur Maximilien Zelevas",
    rt_stabanTuek = "Staban Tuek",
    rt_dukeLetoAtreides = "Duke Leto Atreides",
    rt_hwiNoree = "Hwi Noree",
    rt_darwiOdrade = "Darwi Odrade",
    rt_ramalloTheSayyadina = "Ramallo the Sayyadina",
    rt_glossuTheBeastRabban = "Glossu the Beast Rabban",
    rt_tioHoltzman = "Tio Holtzman",
    rt_baronVladimirHarkonnen = "Baron Vladimir Harkonnen",
    rt_abulurdRabban = "Abulurd Rabban",
    rt_paulAtreides = "Paul Atreides",
    rt_torgTheYounger = "Torg the Younger",
    rt_chatt = "Chatt",
    rt_abulurdHarkonnen = "Abulurd Harkonnen",
    rt_milesTeg = "Miles Teg",
    rt_capitainYelchinOrdara = "Capitain Yelchin Ordara",
    rt_ilesaEcaz = "Ilesa Ecaz",
    rt_esmarTuek = "Esmar Tuek",
    rt_countessArianaThorvald = "Countess Ariana Thorvald",
    rt_albertoGinaztera = "Alberto Ginaztera",
    rt_feydRautha = "Feyd Rautha",
    rt_ladyMargotFenring = "Lady Margot Fenring",
    rt_archdukeArmandEcaz = "Archduke Armand Ecaz",
    rt_tylwythWaff = "Tylwyth Waff",
